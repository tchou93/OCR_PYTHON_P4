...
class Controller:
    ...
    def option_tournament(self):
        ...
        if (user_input_menu_option_tournament == 1):
            ...
            # new_tournament = Tournament(list_input_infos_tournament[0],list_input_infos_tournament[1],list_input_infos_tournament[2],list_input_infos_tournament[3],list_input_infos_tournament[4])
            # self.tournaments.append(new_tournament)

            # list_info_players = self.view.prompt_for_add_players(list_input_infos_tournament[5])
            # for list_info_player in list_info_players:
            #     player = Player(list_info_player[0], list_info_player[1], list_info_player[2], list_info_player[3])
            #     new_tournament.add_player(player)
            # new_tournament.print_tournament()
            # self.view.prompt_for_continue()
            # self.option_tournament()
            self.create_tournament_simu1_in_progress()
            self.create_tournament_simu2_finish()
            self.option_tournament()
    ...
    def option_choose_tournament(self):
        ...
        if user_input_menu_option_tournament < (len(tournaments_in_progress) + 1):
            self.tournament_active = tournaments_in_progress[user_input_menu_option_tournament-1]
            self.option_continue_tournament()
        else:
            self.option_tournament()

    # def option_create_tournament(self):
    #     user_input_menu_create_tournament= self.view.display_menu_create_tournament(self.tournament_active.name)
    #     if (user_input_menu_create_tournament == 1):
    #         pass
    #     elif (user_input_menu_create_tournament == 2):
    #         self.option_start_tournament()
    #     else:
    #         self.option_tournament()

    # def option_continue_tournament(self):
    #     user_input_menu_continue_tournament= self.view.display_menu_continue_tournament()
    #     if (user_input_menu_continue_tournament == 1):
    #         pass
    #     elif (user_input_menu_continue_tournament == 2):
    #         pass
    #     else:
    #         self.option_tournament()

    def option_continue_tournament(self):
        user_input_menu_start_tournament= self.view.display_menu_tournament_continue()
        if (user_input_menu_start_tournament == 1):
            if self.tournament_active.finished == False:
                self.tournament_active.add_tour()
                self.tournament_active.print_tournament()
                self.view.prompt_for_continue()
                self.option_continue_tournament()
            else:
                self.view.prompt_for_continue()
                self.option_continue_tournament()
        elif (user_input_menu_start_tournament == 2):
            pass
        else:
            self.option_tournament()
    ...
    def create_tournament_simu1_in_progress(self):
    ...
    def create_tournament_simu2_finish(self):
        tournament = Tournament("Bellator1","Sevran","28/04/2022","control1","description 1")
        player1 = Player("Feu", "TRAN", "03/10/1985", "M")
        player2 = Player("Feu", "TRAN1", "04/10/1985", "A")
        player3 = Player("Feu", "TRAN2", "05/10/1985", "B")
        player4 = Player("Feu", "TRAN3", "06/10/1985", "C")
        player5 = Player("Feu", "TRAN4", "07/10/1985", "D")
        player6 = Player("Feu", "TRAN5", "08/10/1985", "E")
        player7 = Player("Feu", "TRAN6", "09/10/1985", "F")
        player8 = Player("Feu", "TRAN7", "10/10/1985", "G")
        tournament.add_player(player1)
        tournament.add_player(player4)
        tournament.add_player(player8)
        tournament.add_player(player2)
